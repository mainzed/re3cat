...
The `foolib` library is build using `maven` as JAR-file.

For details have a look at [pom.xml](https://github.com/rgzm/foolib/blob/master/foolib/pom.xml).
...
Run git clone `https://github.com/rgzm/foolib.git` to create a local copy of this repository.
...
Look at [GitHub Pages](https://rgzm.github.io/foolib/) for the latest developer documentation like `maven` and `javadoc`.
